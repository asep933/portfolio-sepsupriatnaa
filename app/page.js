        ...
        <>
            <div className="flex items-center flex-col min-w-full">
                ...
                <form className="flex flex-wrap flex-col mt-0 w-full px-4 text-base lg:translate-x-80 font-semibold">
                    ...
                    <input name="nama" className="mb-3 mt-1 rounded-sm p-2 font-normal shadow-sm w-full lg:w-2/4 focus:outline-orange-300" />

                    <label htmlFor="email">Email</label>
                    <input name="email" className="mb-5 mt-1 rounded-sm p-2 font-normal shadow-sm w-full lg:w-2/4 focus:outline-orange-300" />

                    <label htmlFor="pesan">Feedback</label>
