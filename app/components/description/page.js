...
const Description = ({
  ...
  return (
    <div
      id="description"
      className="center-element fixed z-[9999] h-[16rem] w-[24rem] rounded-md bg-slate-300 bg-opacity-75
    p-5 shadow-md dark:bg-slate-300 dark:bg-opacity-90 lg:h-[24rem] lg:w-[38rem] lg:px-12 lg:shadow-lg"
    >
