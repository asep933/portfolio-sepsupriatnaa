...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    return (
      <>
          <div className="flex justify-between shadow-nav w-full items-center p-2 bg-transparent fixed z-50 backdrop-blur-sm" style={{backgroundColor: 'rgba(255, 191, 219, 0.4)'}}>
